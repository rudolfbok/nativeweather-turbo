...
export const LightRainDay = ({ strokeWidth, ...props }: { strokeWidth: number } & SvgProps) => {
	return (
		<Svg viewBox="0 0 40 40" fill="none" vectorEffect="none" {...props}>
			...
			<Path
				...
				strokeLinejoin="round"
			/>
			<Rect x={15} y={26} width={2} height={8} rx={1} fill="#2793FF" />
			<Rect x={23} y={26} width={2} height={8} rx={1} fill="#2793FF" />
			<Rect x={19} y={28} width={2} height={8} rx={1} fill="#2793FF" />
		</Svg>
	);
};
