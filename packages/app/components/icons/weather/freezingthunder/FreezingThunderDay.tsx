...
export const FreezingThunderDay = ({ strokeWidth, ...props }: { strokeWidth: number } & SvgProps) => {
	return (
		<Svg viewBox="0 0 40 40" fill="none" vectorEffect="none" {...props}>
			...
			/>
			<Path
				d="M21.75 23L18 29.5h5L19.25 36"
				stroke="#F2CF4B"
				strokeWidth={3}
				strokeLinecap="round"
				strokeLinejoin="round"
			/>
			<G clipPath="url(#clip0_45_14)" strokeWidth={0.5} strokeLinecap="round" strokeLinejoin="round">
				<Path
