  ...
  return (
    <>
      ...
      <StyledPressable
        ...
        className={clsx(
          "ios:mt-4 w-full flex-row items-center justify-between rounded-3xl p-4",
          mobile
        )}
      >
        <CardHeader
      ...
      <StyledPressable
        onPress={() => setShowAlertModal(true)}
        className={clsx(
          "absolute web:bg-transparent web:dark:bg-transparent left-0 bottom-0 w-fit flex-row items-center gap-2 rounded-3xl p-2",
          desktop
        )}
      >
        <CardHeader
          icon={<CircleAlert color="#007AFF" size={28} />}
          header={String(alertsLength)}
        />
      </StyledPressable>
