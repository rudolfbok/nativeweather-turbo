...
export const FogNightLandscape = () => {
	return (
		<Svg width={600} height={710} viewBox="0 0 600 710" fill="none">
			<G clipPath="url(#clip0_24_168)">
				<Path fill="url(#paint0_linear_24_168)" d="M0 0H600V710H0z" />
				<Path
			...
			<Defs>
				<LinearGradient id="paint0_linear_24_168" x1={300} y1={0} x2={300} y2={710} gradientUnits="userSpaceOnUse">
					<Stop stopColor="#133256" />
