...
export const PartCloudsDayLandscape = () => {
	return (
		<Svg width={600} height={710} viewBox="0 0 600 710" fill="none">
			<G clipPath="url(#clip0_14_100)">
				<Path fill="url(#paint0_linear_14_100)" d="M0 0H600V710H0z" />
				<Path
			...
			<Defs>
				<LinearGradient id="paint0_linear_14_100" x1={300} y1={0} x2={300} y2={710} gradientUnits="userSpaceOnUse">
					<Stop stopColor="#47ACC9" />
					<Stop offset={1} stopColor="#85DBE9" />
				</LinearGradient>
