...
export const fetchWeather = async (query: string | number[]): Promise<WeatherData> => {
...
export const fetchLocation = async (searchedLocation: string) => {
...
export const fetchSuggestions = async (searchedCity: string) => {
